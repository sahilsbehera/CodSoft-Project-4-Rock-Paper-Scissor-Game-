...
root.config(bg ="light blue")#'#FFE873')
...
Label(text = 'Rock Paper Scissors Game', font = font.Font(size = 20), bg = "yellow").pack()
...
winner_label = Label(text = "Let's start the Game...", fg = 'green', bg = 'black', font = font.Font(size = 13 ) , pady = 8)
winner_label.pack()
